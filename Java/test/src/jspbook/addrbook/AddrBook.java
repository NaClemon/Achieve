...
public class AddrBook {
	...
	private String ab_special;
	private String ab_home;
	...
	public void setAb_hobby(String ab_hobby) {
		this.ab_hobby = ab_hobby;
	}
	public String getAb_special() {
		return ab_special;
	}
	public void setAb_special(String ab_special) {
		this.ab_special = ab_special;
	}
	public String getAb_home() {
		return ab_home;
	}
	public void setAb_home(String ab_home) {
		this.ab_home = ab_home;
	}
