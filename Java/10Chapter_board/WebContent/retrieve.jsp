...
<body>
	...
	<form action="update.do" method="post">
		...
		닉네임<input type="text" name="nickname" value="${retrieve.nickname }"><br/>
		나이<input type="text" name="age" value="${retrieve.age }"><br/>
		내용<textarea name="content" rows="10">
		${retrieve.content }</textarea><br>
