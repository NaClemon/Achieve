							...
							<div class="form-horizontal">
								...
								<div class="form-inline form-group" style="padding-left: 30px">
									<div class="form-group">
										...
										&nbsp;&nbsp;
										<input type="text" class="form-control" id="mon_athle1" name="mon_athle1_name" placeholder="운동 이름">
										&nbsp;&nbsp;
								...
								<div class="form-inline form-group" style="padding-left: 30px">
									<div class="form-group">
										...
										&nbsp;&nbsp;
										<input type="text" class="form-control" id="mon_athle2" name="mon_athle2_name" placeholder="운동 이름">
										&nbsp;&nbsp;
								...
								<textarea class="form-control" id="mon_meal" name="mon_meal" rows="6"></textarea>
								</div>
							<br>
							<br>
							<div class="form-horizontal">
								...
								<div class="form-inline form-group" style="padding-left: 30px">
									<div class="form-group">
										...
										&nbsp;&nbsp;
										<input type="text" class="form-control" id="tue_athle1" name="tue_athle1_name" placeholder="운동 이름">
										&nbsp;&nbsp;
								...
								<div class="form-inline form-group" style="padding-left: 30px">
									<div class="form-group">
										...
										&nbsp;&nbsp;
										<input type="text" class="form-control" id="tue_athle2" name="tue_athle2_name" placeholder="운동 이름">
										&nbsp;&nbsp;
								...
								<textarea class="form-control" id="tue_meal" name="tue_meal" rows="6"></textarea>
								</div>
							<br>
							<br>
							<div class="form-horizontal">
								...
								<div class="form-inline form-group" style="padding-left: 30px">
									<div class="form-group">
										...
										&nbsp;&nbsp;
										<input type="text" class="form-control" id="wed_athle1" name="wed_athle1_name" placeholder="운동 이름">
										&nbsp;&nbsp;
								...
								<div class="form-inline form-group" style="padding-left: 30px">
									<div class="form-group">
										...
										&nbsp;&nbsp;
										<input type="text" class="form-control" id="wed_athle2" name="wed_athle2_name" placeholder="운동 이름">
										&nbsp;&nbsp;
								...
								<textarea class="form-control" id="wed_meal" name="wed_meal" rows="6"></textarea>
								</div>
							<br>
							<br><div class="form-horizontal">
								...
								<div class="form-inline form-group" style="padding-left: 30px">
									<div class="form-group">
										...
										&nbsp;&nbsp;
										<input type="text" class="form-control" id="thu_athle1" name="thu_athle1_name" placeholder="운동 이름">
										&nbsp;&nbsp;
								...
								<div class="form-inline form-group" style="padding-left: 30px">
									<div class="form-group">
										...
										&nbsp;&nbsp;
										<input type="text" class="form-control" id="thu_athle2" name="thu_athle2_name" placeholder="운동 이름">
										&nbsp;&nbsp;
								...
								<textarea class="form-control" id="thu_meal" name="thu_meal" rows="6"></textarea>
								</div>
							<br>
							<br>
							<div class="form-horizontal">
								...
								<div class="form-inline form-group" style="padding-left: 30px">
									<div class="form-group">
										...
										&nbsp;&nbsp;
										<input type="text" class="form-control" id="fri_athle1" name="fri_athle1_name" placeholder="운동 이름">
										&nbsp;&nbsp;
								...
								<div class="form-inline form-group" style="padding-left: 30px">
									<div class="form-group">
										...
										&nbsp;&nbsp;
										<input type="text" class="form-control" id="fri_athle2" name="fri_athle2_name" placeholder="운동 이름">
										&nbsp;&nbsp;
								...
								<textarea class="form-control" id="fri_meal" name="fri_meal" rows="6"></textarea>
								</div>
							<br>
							<br>
							<div class="form-horizontal">
								...
								<div class="form-inline form-group" style="padding-left: 30px">
									<div class="form-group">
										...
										&nbsp;&nbsp;
										<input type="text" class="form-control" id="sat_athle1" name="sat_athle1_name" placeholder="운동 이름">
										&nbsp;&nbsp;
								...
								<div class="form-inline form-group" style="padding-left: 30px">
									<div class="form-group">
										...
										&nbsp;&nbsp;
										<input type="text" class="form-control" id="sat_athle2" name="sat_athle2_name" placeholder="운동 이름">
										&nbsp;&nbsp;
								...
								<textarea class="form-control" id="sat_meal" name="sat_meal" rows="6"></textarea>
								</div>
							<br>
							<br>
							<div class="form-horizontal">
								...
								<div class="form-inline form-group" style="padding-left: 30px">
									<div class="form-group">
										...
										&nbsp;&nbsp;
										<input type="text" class="form-control" id="sun_athle1" name="sun_athle1_name" placeholder="운동 이름">
										&nbsp;&nbsp;
								...
								<div class="form-inline form-group" style="padding-left: 30px">
									<div class="form-group">
										...
										&nbsp;&nbsp;
										<input type="text" class="form-control" id="sun_athle2" name="sun_athle2_name" placeholder="운동 이름">
										&nbsp;&nbsp;
								...
								<textarea class="form-control" id="sun_meal" name="sun_meal" rows="6"></textarea>
								</div>
							<br>
							<br>
