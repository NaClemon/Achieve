...
def extract_features(basedir,extension='.au'):
    ...
    for root, dirs, files in os.walk(basedir):
        ...
        for f in files :
            genre = f.split('/')[5].split('\\')[2].split('.')[0]
            ...
            if (genre == 'hiphop' or genre == 'rock' or genre == 'pop' or genre == 'country'):
                ...
                pass
    lenfea = len(features) / 2
    features = np.asarray(features).reshape(int(lenfea),164864)
...
if __name__ == "__main__":
    trainingPath = 'C:/Users/995sk/Downloads/genres.tar/genres'
    ...
    with open('../../4GenreTest.data', 'wb') as f:
        pickle.dump(train_data, f)

    with open('../../4GenreTest.labels', 'wb') as f:
